    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subjects', models.ManyToManyField(related_name='students', to='members.subjects')),
            ],
        ),
        migrations.CreateModel(
            name='TeacherProfile',
            fields=[
                ...
                ('subjects_taught', models.ManyToManyField(related_name='teachers', to='members.subjects')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
